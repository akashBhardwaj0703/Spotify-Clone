...
async function getSongs(folder) {
    ...
    currFolder = folder;
    let a = await fetch(`https:/spotify-clone-eight-pink-16.vercel.app/songs/${folder}/`)
...
function playSong(track, pause = false) {
    ...
    curSong.src = `https:/spotify-clone-eight-pink-16.vercel.app/songs/${currFolder}/` + track + ".mp3";
...
async function displayAlbum() {
    // currFolder = folder;
    let a = await fetch(`https:/spotify-clone-eight-pink-16.vercel.app/songs/`)
    // console.log(a)
    let responses = await a.text();
    ...
    for(let i =0; i<array.length; i++){
        const e = array[i];
        if (e.href.includes("https:/spotify-clone-eight-pink-16.vercel.app/songs")) {
            let folder = (e.href.split('/').splice(-2)[0]);
            //Now get metadeta of the folder

            let a = await fetch(`https:/spotify-clone-eight-pink-16.vercel.app/songs/${folder}/info.json`)
            ...
            cardContiner.innerHTML = cardContiner.innerHTML + `<div class="card rounded" data-folder="${folder}">
                ...
                <img class="rounded" width="160px" height="160px" src="https:/spotify-clone-eight-pink-16.vercel.app/songs/${folder}/cover.jpg" alt="card">
